  ...
  return (
    <div className='m-view-full max-w-[100vw]'>
      <section className='relative'>
        <video src='/images/sample-10s.mp4' muted loop autoPlay playsInline className='h-auto w-full' />
        ...
        <div className='absolute right-1/2 top-1/2 z-10 -translate-y-1/2 translate-x-1/2 text-center'>
          ...
          <p className='mt-4 text-center text-white'>Forge connections, deepen emotions</p>
        </div>
      </section>
    </div>
  )
