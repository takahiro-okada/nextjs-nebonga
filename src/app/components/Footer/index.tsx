      ...
      <div className='mx-auto max-w-1140 px-3'>
        <div className='md:flex md:justify-between md:items-center'>
          ...
          <div className='mt-10 sm:flex sm:items-center sm:justify-between'>
            <ul className='mb-6 flex flex-wrap items-center justify-center text-sm font-medium sm:mb-0 md:f'>
        ...
        <div className='mt-10 md:flex md:justify-between md:items-center md:mt-16'>
          <div className=''>
