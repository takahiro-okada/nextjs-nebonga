        ...
        <CommonContainer>
          <div className='md:ml-16 md:flex'>
            <div className='pt-16 md:w-1/2 md:pt-12'>
              <span className='absolute right-0 top-0 w-fit translate-x-0 rotate-90 text-sm tracking-widest after:absolute after:top-1/2 after:ml-6 after:border-t-[1px] after:inline-block after:w-16 after:h-1 after:border-black md:-left-5 md:top-8 lg:after:w-52'>
                About
              </span>
